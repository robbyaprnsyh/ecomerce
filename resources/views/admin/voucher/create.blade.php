...
<form action="{{ route('voucher.store') }}" method="POST">
    ...
    <div class="col-lg-12">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group mb-3">
                        <input type="number" name="diskon"
                            class="form-control mb-2 numbers  @error('diskon') is-invalid @enderror"
                            placeholder="diskon Produk" value="1" min="0" max="100">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="waktu_mulai"
                        class="form-control mb-2  @error('waktu_mulai') is-invalid @enderror" placeholder="Waktu Mulai"
        ...
        <div class="d-flex float-start">
            <a href="/admin/voucher" class="btn btn-danger me-3"><svg xmlns="http://www.w3.org/2000/svg" width="20"
