...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('provinsi.update', $provinsis->id) }}" method="post">
            @csrf
            @method('put')
            <div class="col-lg-12">
                <div class="card mb-4 shadow-lg rounded card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Tambah provinsi</h4>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" name="provinsi"
                                ...
                                placeholder="Nama provinsi" value="{{ $provinsis->provinsi }}">
                            @error('provinsi')
                ...
                <div class="d-flex float-start">
                    <a href="/admin/provinsi" class="btn btn-danger me-3"><svg xmlns="http://www.w3.org/2000/svg"
