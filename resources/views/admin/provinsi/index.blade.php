...
@section('content')
    ...
    <div class="card shadow-lg rounded card p-2">
        <div class="card-header" id="#atas">
            <span class="fs-4 fw-700">Data provinsi</span>
            <a href="{{ route('provinsi.create') }}" class="btn btn-sm btn-primary float-end "><svg
                                    ...
                                    <td>
                                        <form action="{{ route('provinsi.destroy', $provinsi->id) }}" method="post">
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalCenter{{ $provinsi->id }}"><svg
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="modalCenter{{ $provinsi->id }}" tabindex="-1"
                                                aria-hidden="true">
