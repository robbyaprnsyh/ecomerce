...
@section('content')
    ...
    <div class="card shadow-lg rounded card p-2">
        <div class="card-header" id="#atas">
            <span class="fs-4 fw-700">Data Kecamatan</span>
            <a href="{{ route('kecamatan.create') }}" class="btn btn-sm btn-primary float-end "><svg
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('kecamatan.destroy', $kecamatan->id) }}" method="post">
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="modalCenter{{ $kecamatan->id }}" tabindex="-1"
                                                aria-hidden="true">
