...
@section('content')
    <div class="container-fluid">
        <form action="{{ route('metodePembayaran.update', $metodePembayarans->id) }}" method="post">
            @csrf
            @method('put')
            <div class="col-lg-12">
                <div class="card mb-4 shadow-lg rounded card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Tambah metodePembayaran</h4>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label">Nama metodePembayaran</label>
                            <input type="text" name="metodePembayaran"
                                class="form-control mb-2  @error('metodePembayaran') is-invalid @enderror"
                                placeholder="Nama metodePembayaran" value="{{ $metodePembayarans->metodePembayaran }}">
