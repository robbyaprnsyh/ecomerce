...
@section('content')
    ...
    <div class="card shadow-lg rounded card p-2">
        <div class="card-header" id="#atas">
            <span class="fs-4 fw-700">Data Kota/Kabupaten</span>
            <a href="{{ route('kota.create') }}" class="btn btn-sm btn-primary float-end "><svg
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('kota.destroy', $kota->id) }}" method="post">
                                            @csrf
                                            @method('delete')
                                            <a href="{{ route('kota.edit', $kota->id) }}" class="btn btn-sm btn-secondary"
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="modalCenter{{ $kota->id }}" tabindex="-1"
                                                aria-hidden="true">
