                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="/" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">SUKO  </span>
                            </a>
                        </div>
                        <!-- /Logo -->
                        <div class="text-center">
                            <h4 class="mb-2">Welcome to SUKO    !</h4>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('register') }}" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="jenis_kelamin" class="form-label" style="margin-right: 5px">Jenis
                                    kelamin</label>
